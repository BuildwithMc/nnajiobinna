...
!(function () {
  ...
  null !== (e = document.querySelector('[data-bs-toggle="mode"]')) &&
    ...
    null != (a = document.querySelector(".navbar.fixed-top")) &&
      ...
      (r = function (e) {
        20 < e.currentTarget.pageYOffset
          ? (a.classList.add("navbar-stuck"), a.classList.contains("navbar-ignore-dark-mode") && a.classList.remove("ignore-dark-mode"))
          : (a.classList.remove("navbar-stuck"), a.classList.contains("navbar-ignore-dark-mode") && a.classList.add("ignore-dark-mode"));
      }),
    ...
    null != (i = document.querySelector(".btn-scroll-top")) &&
      ...
      window.addEventListener("scroll", function (e) {
        e.currentTarget.pageYOffset > n ? i.classList.add("show") : i.classList.remove("show"),
    ...
    (function () {
      for (
        var e = document.querySelectorAll(".swiper"),
          t = function (e, t) {
            (a = null != t.dataset.swiperOptions ? JSON.parse(t.dataset.swiperOptions) : a).thumbnails &&
            ...
            var r,
              ...
              t = new Swiper(t, a);
            a.controlledSlider &&
              (null != (o = document.querySelector(a.controlledSlider)).dataset.swiperOptions && (n = JSON.parse(o.dataset.swiperOptions)), (o = new Swiper(o, n)), (t.controller.control = o)),
              a.bindedContent &&
        ...
        for (var t = 0; t < e.length; t++) {
          var r = void 0,
            a =
              ...
              e[t].classList.contains("date-range") ? { plugins: [new rangePlugin({ input: e[t].dataset.linkedInput })] } : "{}"),
    ...
    (function () {
      for (var e = document.querySelectorAll("[data-binded-label]"), t = 0; t < e.length; t++)
    ...
    (function () {
      for (var e = document.querySelectorAll("[data-binded-content]"), t = (document.querySelectorAll("[data-scroll-binded]"), document.querySelector(".binded-content"), 0); t < e.length; t++)
    ...
    (function () {
      for (var n = document.querySelectorAll(".count-input"), e = 0; e < n.length; e++)
        !(function (e) {
          var e = n[e],
      ...
      if (0 !== e.length)
        for (var t = 0; t < e.length; t++)
          e[t].addEventListener("click", function (e) {
            ...
            if ((e.classList.toggle("all-checked"), e.classList.contains("all-checked"))) for (var r = 0; r < t.length; r++) t[r].checked = !0;
